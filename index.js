...
modalWrapper.addEventListener("click", (e) => {
  if (
    e.target.classList.contains("modal_header") ||
    e.target.classList.contains("modal_body") ||
    e.target.classList.contains("modal_footer") ||
    e.target.classList.contains("modal_title") ||
    e.target.classList.contains("modal_submit")
  ) {
    modalWrapper.style.display = "flex";
